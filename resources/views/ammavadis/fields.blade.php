...
<div class="form-group col-sm-4">
    ...
    {!! Form::text('distance_from_house', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
</div>

<!-- Whatsap No Field -->
<div class="form-group col-sm-4">
    {!! Form::label('whatsap_no', 'Whatsap No:') !!}
    {!! Form::text('whatsap_no', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
</div>

<div class="col-md-12"> 
    <p class="rounded h2 text-center py-2 bg-secondary mt-1" >MOTHER DETAILS</p>
    <div class="row p-2">
        <!-- Mother Education Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('mother_education', 'Mother Education:') !!}
            {!! Form::text('mother_education', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Mother Aadhar No Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('mother_aadhar_no', 'Mother Aadhar No:') !!}
            {!! Form::text('mother_aadhar_no', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Mother Phone No Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('mother_phone_no', 'Mother Phone No:') !!}
            {!! Form::text('mother_phone_no', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Mother Bank No Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('mother_bank_no', 'Mother Bank No:') !!}
            {!! Form::text('mother_bank_no', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Mother Bank Ifsc Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('mother_bank_ifsc', 'Mother Bank Ifsc:') !!}
            {!! Form::text('mother_bank_ifsc', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Mother Bank Name Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('mother_bank_name', 'Mother Bank Name:') !!}
            {!! Form::text('mother_bank_name', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>
    </div>
</div>

<div class="col-md-12"> 
    <p class="rounded h2 text-center py-2 bg-secondary mt-1" >FATHER DETAILS</p>
    <div class="row p-2">
        <!-- Father Education Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('father_education', 'Father Education:') !!}
            {!! Form::text('father_education', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Father Phone No Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('father_phone_no', 'Father Phone No:') !!}
            {!! Form::text('father_phone_no', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Father Bank No Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('father_bank_no', 'Father Bank No:') !!}
            {!! Form::text('father_bank_no', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Father Aadhar No Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('father_aadhar_no', 'Father Aadhar No:') !!}
            {!! Form::text('father_aadhar_no', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Father Bank Name Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('father_bank_name', 'Father Bank Name:') !!}
            {!! Form::text('father_bank_name', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Father Bank Ifsc Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('father_bank_ifsc', 'Father Bank Ifsc:') !!}
            {!! Form::text('father_bank_ifsc', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>
    </div>
</div>

<div class="col-md-12"> 
    <p class="rounded h2 text-center py-2 bg-secondary mt-1" >PAST AMMAVADI DETAILS</p>
    <div class="row p-2">
        <!-- Past Amavadi Cfms Id Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('past_amavadi_cfms_id', 'Past Amavadi Cfms Id:') !!}
            {!! Form::text('past_amavadi_cfms_id', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Past Amavadi Bank No Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('past_amavadi_bank_no', 'Past Amavadi Bank No:') !!}
            {!! Form::text('past_amavadi_bank_no', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Past Amavadi Bank Name Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('past_amavadi_bank_name', 'Past Amavadi Bank Name:') !!}
            {!! Form::text('past_amavadi_bank_name', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Boots Size Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('boots_size', 'Boots Size:') !!}
            {!! Form::text('boots_size', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>
    </div>
</div>
...
<div class="col-md-12"> 
    <p class="rounded h2 text-center py-2 bg-secondary mt-1" >VOLUNTEER  DETAILS</p>
    <div class="row p-2">
        <!-- Village Volunteer Name Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('village_volunteer_name', 'Village Volunteer Name:') !!}
            {!! Form::text('village_volunteer_name', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>

        <!-- Village Volunteer No Field -->
        <div class="form-group col-sm-4">
            {!! Form::label('village_volunteer_no', 'Village Volunteer No:') !!}
            {!! Form::text('village_volunteer_no', null, ['class' => 'form-control', 'maxlength' => 255]) !!}
        </div>
    </div>
</div>

<div class="col-md-12"> 
    <p class="rounded h2 text-center py-2 bg-secondary mt-1" >REQUIREMENTS</P>
    <div class="row p-2">
                <!-- Android Phone Field -->
        <div class="form-group col-sm-4">
        ...
        <div class="form-group col-sm-12 col-lg-12">
            ...
            {!! Form::textarea('other', null, ['class' => 'form-control', 'maxlength' => 65535]) !!}
        </div>
